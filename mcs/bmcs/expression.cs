...
namespace Mono.CSharp {
	...
	public class Binary : Expression {
		...
		{
			// Keep String/Nothing and generic-parameter/Nothing comparisons on the
			// intrinsic VB path. Older dead operator code mixed these cases into a
			// monolithic resolver; the live binder handles them more narrowly here.
		...
		bool IsOfType (EmitContext ec, Type l, Type r, Type t, bool check_user_conversions)
		{
			...
			return Convert.ImplicitUserDefinedConversionExists (ec, l, t) ||
				Convert.ImplicitUserDefinedConversionExists (ec, r, t);
		}
		...
		//
		// If `check_user_conv' is true, also consider implicit user-defined CType
		// operators through Convert.ImplicitUserDefinedConversionExists so numeric
		// promotion stays aligned with conversion applicability.
		//
