...
[assembly:AssemblyCompanyAttribute("MonoTest <C>ompany| Name.")]
...
namespace TestUserConfig.Path
{
	class Program
	{
		const string expCompanyDirName = "MonoTest__C_ompany__Name"; /* Pulled from assembly attribute. */
		const string expVersionDirName = "4.3.2.1"; /* Pulled from the assembly attribute. */
		const string expProductDirNamePart1 = "t50.exe"; /* Taken from AppDomain.CurrentDomain.FriendlyName. Product name attribute is ignored. */
