...
{
	[ConfigurationProperty ("MySection")]
	public MyElementCollection MyElements {
		get { return (MyElementCollection) this ["MySection"]; }
	}
}

/* Test a child element of a ConfigurationSection with the same name as the section. */
public class Driver
{
